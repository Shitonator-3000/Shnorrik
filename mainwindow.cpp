...
void MainWindow::Verify()
{
    ...
    if ( temp == x ) ui->lineEdit->setText( QString::fromLocal8Bit("Подлинная!") );
    else ui->lineEdit->setText( QString::fromLocal8Bit("Подделка!") );
}

// инициализация и генерация входных параметров
void MainWindow::Inicialization() {
    if ( ui->lineEdit_M->text().isEmpty() ) ui->lineEdit_M->setText( "James" );
}
